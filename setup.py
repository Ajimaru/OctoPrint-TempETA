...
plugin_identifier = "temp_eta"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_temp_eta"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-TempETA"
...
# module
plugin_description = "OctoPrint plugin that shows ETA for bed/hotend heating and cooling, with advanced temperature prediction algorithms."
...
plugin_url = "https://github.com/Ajimaru/OctoPrint-TempETA"
